...
# Créer une pull request à partir d'un fork

## Pré-requis
- Avoir forké un depôt original

## Procédure
1. Cloner le fork localement
2. Créer une nouvelle branche pour vos modifications
3. Faites vos modifications et sauvegarder
4. Envoyer vos modifications (push) et valider vos modifications (commit)
5. Pousser la nouvelle branche vers votre fork Github
6. Synchroniser votre fork avec le dépôt original (pour prévenir les conflits)
7. Cliquer sur "Compare & pull request"
(base repository = le depot original, compare branch = votre nouvelle branch)
8. Donnez un titre et une description qui évoque clairement vos modifications
